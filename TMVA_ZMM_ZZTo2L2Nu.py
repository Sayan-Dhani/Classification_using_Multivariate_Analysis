...
useFischer = False  # Fischer discriminant
...
if useKeras:
    try:
        ...
        ROOT.Warning("TMVA_ZMM_ZZTo2L2Nu", "Skip using Keras since tensorflow is not available")
        useKeras = False

outputFile = TFile.Open("TMVA_ZMM_ZZTo2L2Nu.root", "RECREATE")
...
#else:
inputFileSig = TFile.Open("Sig_tree_ZMM.root")
inputFileBKG = TFile.Open("BKG_tree_ZZTo2L2Nu.root")


# --- Register the training and test trees
signalTree = inputFileSig.Get("tree")
backgroundTree = inputFileBKG.Get("tree")
signalTree.Print()
number = signalTree.GetEntries()
...
loader.AddVariable("dPhiMET_u1")
loader.AddVariable("mass_uu")
loader.AddVariable("MET_pt")
loader.AddVariable("pTu1")
loader.AddVariable("pTu2")
loader.AddVariable("Nele")
loader.AddVariable("Njet")
loader.AddVariable("Nbjet")
#loader.AddVariable("HpT_bjet")
...
loader.PrepareTrainingAndTestTree(
    mycuts, mycutb, nTrain_Signal=number/2, nTrain_Background=number/2, SplitMode="Random", NormMode="NumEvents", V=False
)
